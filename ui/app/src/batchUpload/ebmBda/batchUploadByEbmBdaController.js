/*
 * BatchUploadByEbmBdaController.js
 *
 ...
 */
(function () {
	angular.module('productMaintenanceUiApp').controller('BatchUploadByEbmBdaController', batchUploadByEbmBdaController);
	batchUploadByEbmBdaController.$inject = ['$scope', 'urlBase', 'BatchUploadResultsFactory', 'BatchUploadApi'];
	/**
	 ...
	 */
	function batchUploadByEbmBdaController($scope, urlBase, batchUploadResultsFactory, batchUploadApi) {

		var self = this;

		self.downloadTemplateURL = urlBase + '/pm/ebmBda/downloadTemplate';
