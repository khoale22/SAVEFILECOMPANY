...
public class CostOwner implements Serializable {
	...
	@Formula("TRIM(BOTH ' ' FROM cst_own_nm)")
	private String trimmedCostOwnerName;
	 ...
	 */
	public String getTrimmedCostOwnerName() {
		return trimmedCostOwnerName;
	}

	/**
	 * Set trimmedCostOwnerName of the CostOwner
	 */
	public void setTrimmedCostOwnerName(String trimmedCostOwnerName) {
		this.trimmedCostOwnerName = trimmedCostOwnerName;
	}
