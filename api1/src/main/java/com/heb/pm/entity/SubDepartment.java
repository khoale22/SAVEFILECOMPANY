 ...
 */
@Entity
@Where(clause = "str_dept_nbr not in (' ','A','B','C','D','E','F','G','H','I','J','K','L','0','00')")
@Table(name = "str_dept")
...
public class SubDepartment implements Serializable{
	...
	public SubDepartment(SubDepartment subDepartment){
		super();
		this.setKey(new SubDepartmentKey(subDepartment.getKey()));
		this.setName(subDepartment.getName());
		this.setReportGroupCode(subDepartment.getReportGroupCode());
		this.setGrossProfitLow(subDepartment.getGrossProfitLow());
		this.setGrossProfitHigh(subDepartment.getGrossProfitHigh());
		this.setShrinkLow(subDepartment.getShrinkLow());
		this.setShrinkHigh(subDepartment.getShrinkHigh());
	}
	...
	/**
	 * The constant DEPARTMENT_CODE_FORMAT_BY_SUB.
	 */
	public static final String DEPARTMENT_CODE_FORMAT_BY_SUB = "%s-%s";
	...
	/**
	 * Returns the department key code with format deparment code - sub_department code.
	 *
	 * @return A String representation of the department key code with format deparment code - sub_department code.
	 */
	public String getDepartmentKey() {
		return String.format(SubDepartment.DEPARTMENT_CODE_FORMAT_BY_SUB,
				this.key.getDepartment().trim(), this.key.getSubDepartment().trim());
	}
