/*
 * ProductScanCodeWicServiceClient
 *
...
/**
 * This is ProductScanCodeWicServiceClient class.
 *
 * @author vn55306
 * @since 1.0.0
 */
@Service
public class ProductScanCodeWicServiceClient extends BaseJavaDao {
    private static final Logger LOGGER = LogManager.getLogger(ProductScanCodeWicServiceClient.class);
    private static String entity = "ProdScnCdWic";

    @Override
    public String submitRequest(List<BaseVO> objects, String url, String apiKey) throws WicException {
        LOGGER.info("ProdScnCdWic= "+url+"--"+apiKey);
        RestTemplate restTemplateWic = new RestTemplate();
        String responseExtractor = null;
        try {
            HttpEntity<String> request = this.createRequest(entity, objects, apiKey);
            responseExtractor = restTemplateWic.postForObject(url, request, String.class);
