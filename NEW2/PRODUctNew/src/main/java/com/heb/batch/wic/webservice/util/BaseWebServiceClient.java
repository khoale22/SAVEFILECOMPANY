...
import com.heb.xmlns.ei.Authentication;
...
public abstract  class BaseWebServiceClient<A, P> {
	...
	private static final Logger LOGGER = LogManager.getLogger(BaseWebServiceClient.class);
	...
	private void initialize(){
		apiKey = this.jobParamDAO.getConfigurationInfor(JobParamDAO.J50X100_EMAIL_WS_APIKEY);
	}
	/**
	...
	private void configureApiKey() {
		LOGGER.info("configureApiKeyconfigureApiKey ="+this.apiKey);
		BindingProvider provider = this.getPortAsProvider();
