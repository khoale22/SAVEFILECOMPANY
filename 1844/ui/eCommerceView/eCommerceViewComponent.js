...
(function () {
	...
	function ECommerceViewController(eCommerceViewApi, $scope, $timeout, $filter, $sce, $rootScope, vocabularyService, productGroupService, $state, appConstants, productSearchService, taskService, $location, permissionsService, customHierarchyService) {
        ...
        self.SELECT_DATE_SUBSCRIPTION_ELIGIBLE = 'Please select the date for the Subscription Eligible.';
        ...
        /**
         * The (select for heb com) button is disable or not.
         * @type {boolean}
         */
        self.isDisableHebComButton = false;
		/**
		...
		self.buildDataForSubscriptionDatePicker = function (eCommerceViewDetails) {
			...
			self.eCommerceViewDetails["subscriptionEndDateOpen"] = false;
                        self.eCommerceViewDetails["subscriptionStartDate"] = null;
                        self.eCommerceViewDetails["subscriptionEndDate"] = null;
                        self.eCommerceViewDetails["subscriptionStartDateOrg"] = null;
                        self.eCommerceViewDetails["subscriptionEndDateOrg"] = null;
		...
		self.save = function () {
            ...
            if (self.isDataChanged()) {
                ...
                // Show message.
                if(self.eCommerceViewDetails.subscription && self.eCommerceViewDetails.subscriptionStartDate == null && self.eCommerceViewDetails.subscriptionEndDate == null) {
                    self.error = self.SELECT_DATE_SUBSCRIPTION_ELIGIBLE;
                } else {
		...
		self.validateDataChanged = function () {
			...
			if (self.eCommerceViewDetails.subscription && self.isStartDateSubscriptionChanged()) {
			...
			if (self.eCommerceViewDetails.subscription && self.isEndDateSubscriptionChanged()) {
		...
		self.publish = function () {
            ...
            if (self.eCommerceViewDetails.customerHierarchyPrimaryPaths != null) {
                countPrimaryPath = self.eCommerceViewDetails.customerHierarchyPrimaryPaths.length;
            }
			if (self.isValidatePublishData() && countPrimaryPath == 1) {
        ...
        self.isValidatePublishData = function () {
            if (self.eCommerceViewDetails.size == null || self.eCommerceViewDetails.size == undefined) {
                return false;
            } else if (self.eCommerceViewDetails.size.mandatory !== undefined && self.eCommerceViewDetails.size.mandatory !== null
						&& self.eCommerceViewDetails.size.mandatory) {
                return false;
            }
            if (self.eCommerceViewDetails.brand == null || self.eCommerceViewDetails.brand == undefined ) {
                return false;
            } else if (self.eCommerceViewDetails.brand.mandatory !== undefined && self.eCommerceViewDetails.brand.mandatory !== null
						&& self.eCommerceViewDetails.brand.mandatory) {
                return false;
            }
            if (self.eCommerceViewDetails.displayName == null || self.eCommerceViewDetails.displayName == undefined) {
                return false;
            } else if (self.eCommerceViewDetails.displayName.mandatory !== undefined && self.eCommerceViewDetails.displayName.mandatory !== null
						&& self.eCommerceViewDetails.displayName.mandatory) {
                return false;
            }
            ...
            if (self.currentTab.id != FAVOR_TAB_ID) {
                ...
                if (self.eCommerceViewDetails.romanceCopy === null || self.eCommerceViewDetails.romanceCopy === undefined) {
                    return false;
                } else if (self.eCommerceViewDetails.romanceCopy.mandatory !== undefined && self.eCommerceViewDetails.romanceCopy.mandatory !== null
							&& self.eCommerceViewDetails.romanceCopy.mandatory) {
                    return false;
                }
            }
            return true;
		...
		self.dataSourceResponseSuccess = function (result) {
            ...
            if(self.eCommerceViewAttributePriority.attributeId === self.LOG_ATTR_ID_SIZE || self.eCommerceViewAttributePriority.attributeId === self.LOG_ATTR_ID_ROMANCE_COPY){
                self.getECommerceViewPriorityDetailsByEditableSource();
            }
		...
		self.getECommerceViewPriorityDetailsByEditableSource = function(){
			...
			angular.forEach(self.eCommerceViewAttributePriority.eCommerceViewAttributePriorityDetails, function(eCommerceViewPriorityDetails){
				if(result == null && eCommerceViewPriorityDetails.sourceEditable === true){
                    if((angular.equals(eCommerceViewPriorityDetails.content.content, EMPTY) || eCommerceViewPriorityDetails.content.content === null)
					   && self.eCommerceViewAttributePriority.masterDataExtensionAttribute !== null) {
                        eCommerceViewPriorityDetails.content.content = angular.copy(self.eCommerceViewAttributePriority.masterDataExtensionAttribute.attributeValueText);
                        if(self.eCommerceViewAttributePriority.attributeId !== self.LOG_ATTR_ID_SIZE ){
                        	eCommerceViewPriorityDetails.htmlContent.content = angular.copy(self.eCommerceViewAttributePriority.masterDataExtensionAttribute.attributeValueText);
                        }
                    }
        ...
        /**
         * The (select for heb com) button is disable or not.
         * @param eCommerceViewPriorityDetails the eCommerceViewPriorityDetails
         */
		self.isDisableSelectForHebComButton = function(eCommerceViewPriorityDetails){
		    if(!self.htmlMode){
                if(self.isWaitingForCheckSpellingResponse
                    || self.isWaitingForResponsePopup
                    || (eCommerceViewPriorityDetails.sourceEditable && eCommerceViewPriorityDetails.selected && angular.equals( eCommerceViewPriorityDetails.content.content , EMPTY))){
                    self.isDisableHebComButton = true;
                }else {
                    self.isDisableHebComButton = false;
                }
            }else{
